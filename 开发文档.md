...
- [ ] 指标注入：`cache.redis_hits/misses/latency_ms` 与 `cache.lru_hits`
- [ ] 清理与回滚：`clear_cache` 同步删除 Redis 键；开关 `ENABLE_REDIS_CACHE`
- [ ] 队列方案评审（暂不开发）
...
**文档版本**: v1.6  
**最后更新**: 2025-11-27T20:35:20+08:00 (Asia/Shanghai)
